...
class NoteOffsetState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		FlxCamera.defaultCameras = [camGame]; // Deprecated, but somehow the scene doesn't work without this
	...
	{
		dumbTexts.members[0].text = 'Rating Offset:';
		dumbTexts.members[1].text = '[' + ClientPrefs.comboOffset[0] + ', ' + ClientPrefs.comboOffset[1] + ']';
		dumbTexts.members[2].text = 'Numbers Offset:';
		dumbTexts.members[3].text = '[' + ClientPrefs.comboOffset[2] + ', ' + ClientPrefs.comboOffset[3] + ']';
	}
